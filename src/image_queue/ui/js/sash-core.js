...
(function (root, factory) {
  ...
  const WINDOWS = [
    { id: 'stats',    title: 'Progress' },
    { id: 'filters',  title: 'Source folder' },
    { id: 'stack',    title: 'Workflow' },
    { id: 'config',   title: 'Settings' },
    { id: 'composer', title: 'Prompt' },
    { id: 'people',   title: 'Image queue' },
    { id: 'log',      title: 'Activity' },
    // Message archive windows (added in layout version 2)
    { id: 'history',   title: 'Job history' },
    { id: 'userdb',    title: 'Saved outputs' },
    { id: 'collector', title: 'File changes' },
    // Labels + database management (added in layout version 3)
    { id: 'labels',    title: 'Variables' },
    { id: 'dbconn',    title: 'Chrome URLs' },
    // AI assistant windows (added in layout version 4)
    { id: 'botchat',   title: 'Job inspector' },
    { id: 'botprompt', title: 'Prompt templates' },
  ];
