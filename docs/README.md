...
- `archive/2026-09-19-captcha-watcher-isolation/` — full audit, Watcher-only CAPTCHA runtime contract, official 2Captcha SDK adapter, page-isolated monitoring, UI repair contract, implementation record, and verification plan
