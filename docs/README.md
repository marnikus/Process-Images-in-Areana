...
|---|---|---|
| [`current/SYSTEM_OF_RECORD.md`](current/SYSTEM_OF_RECORD.md) | Authoritative spec: behaviour table (22 capabilities), state machine 00-22, core flow plan→execute, invariants, storage map JSON-only, key modules & layers, tests, quality gates, UI 16 windows, history pointers | Before any code change — understand what system actually does |
...
- `archive/2026-09-20-live-processing-and-watcher-scope/` — **integrated through S0–S10**. Original first-round evidence/design retained as history; superseding decisions and the final audit are in `docs/archive/2026-09-20-dynamic-urls-and-worker-debug/s10-verification.md`.
- `archive/2026-09-20-dynamic-urls-and-worker-debug/` — **integrated S0–S10**: dynamic URLs and one cadence control, Watcher-only capped pause, re-queue resets, always-live run, receiver icon, 16 registered windows and Live Worker & Queue Debug. `design.md`, `tdd-interfaces.md` and `quality-budget.md` remain historical plans; `merge-note.md` corrects their base assumptions. `s8-verification.md`, `s9-verification.md`, and `s10-verification.md` record executed tests, measured gates and deviations. The final audit does not retroactively certify S6/S7 placeholders or their missing same-stage doc updates; saved-page fixtures and real-Chrome acceptance remain explicit limitations.
...
*Last updated: 2026-09-20 — S10 consolidation. Full stage ledger, historical exceptions and final measurements: `docs/archive/2026-09-20-dynamic-urls-and-worker-debug/s10-verification.md`.*

**2026-09-20 — S8 integrated:** unified 16-window catalog, grid v6 migration, and Page Pool rescued into `live_debug`; registered shell only (worker/queue detail is not implemented in this stage). Verification: `docs/archive/2026-09-20-dynamic-urls-and-worker-debug/s8-verification.md`.

**2026-09-20 — S9 integrated:** Live Worker & Queue Debug now has queue/receiver heads,
job/status/time lines and read-only cadence. Last-settled pause evidence is labeled;
