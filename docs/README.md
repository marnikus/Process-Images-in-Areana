...
- `archive/2026-09-18-image-reference-paste-regression/design.md` — superseded first and second speculative post-merge reference-image corrections
- `archive/2026-09-18-working-branch-composer-restoration/design.md` — live-validation correction: exact image-input and prompt-setter interaction restored from known-working branch commit `032dfc6`, while retaining protocol and required-block failure gates
