...
- `archive/2026-09-16-auto-connect-url-parsing/design.md` — AUTO-CONNECT & URL PARSING: strict-endpoint scanning, pattern detection, unique-page-id linking, adopt-not-redial reconciliation, event watcher, stored settings
- `archive/2026-09-16-job-cooldown/` — JOB CYCLE & COOLDOWN design plus its corrections and fix notes
