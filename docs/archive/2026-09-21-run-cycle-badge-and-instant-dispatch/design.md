...
*Invariant number:* this item is **I-57** in `SYSTEM_OF_RECORD.md` — it was drafted as I-56, but the parallel branch `arena/01a0c355-…` (Reparse sweep + checkbox owns pool) landed its own I-56 and was merged in on top; the number moved, the text did not.
