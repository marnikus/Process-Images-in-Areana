...
Read `docs/rebuild/README.md`, the relevant design and `docs/rebuild/09-FOUR-HOUR-STEPS.md` before changing code. Owner authorized Steps 1–3 and pushing this session branch; later stages remain separately reviewable. Missing Arena evidence still blocks the site adapter.
...
- Domain coverage floors: statements ≥90%, branches ≥85%; test individual critical invariants regardless of percentage. Targeted mutation tests for safety rules as they land.
