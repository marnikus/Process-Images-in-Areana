...
BLOCK_DEFINITIONS = {
    ...
    "SUBMIT": {
        ...
        "default_match_text": "",
        "default_click_selector": "",
        "default_fallback_selector": "button:has(svg)",
        "default_fallback_text": "Send",
        "default_color": "#FFAA00",
        "default_timeout_ms": 10000,
        "default_pre_delay_ms": 300,
        "default_highlight_ms": 2000,
        ...
        "category": "action",
        "labels": {
            "selector": "Send button selector (CSS)",
    ...
    "WAIT_OUTPUT": {
        ...
        "description": "Wait for genuinely new output image (baseline comparison), GREEN rect on new output",
        "icon": "hourglass_top",
        "default_enabled": True,
        "default_selector": "div.no-scrollbar img[src*=\".r2.cloudflarestorage.com/\"], div[data-testid=\"output\"] img, div.no-scrollbar img",
