...
window.SashCoreConstants = (() => {
  const WINDOWS = [
    ...
    { id: 'arena_presets', title: 'Arena Presets' }, { id: 'live_debug', title: 'Live Worker & Queue Debug' }, { id: 'job_history', title: 'Job History' }, { id: 'firefox_auto', title: 'Firefox auto with Extension' },
  ];
