...
function sashDefaultTree() {
  return sashSplit('col', [
    ...
    sashSplit('row', [
      ...
      sashSplit('col', [sashLeaf('browser'), sashLeaf('arena_presets'), sashLeaf('progress'), sashLeaf('watcher'), sashLeaf('live_debug')], [24, 20, 18, 20, 18]),
    ], [45, 35, 20]),
    sashLeaf('log'),
  ], [38, 40, 22]);
}
...
function sashLayoutA() {
  ...
  ], [7, 5, 10, 8, 6, 6, 6, 7, 5, 5, 6, 6, 6, 6, 5, 6]);
}
...
function sashLayoutB() {
  return sashSplit('row', [
    ...
    sashSplit('col', [sashLeaf('browser'), sashLeaf('settings'), sashLeaf('captcha'), sashLeaf('recordings'), sashLeaf('arena_presets'), sashLeaf('run'), sashLeaf('live_debug')], [22, 13, 13, 13, 13, 13, 13]),
  ], [35, 35, 30]);
}
