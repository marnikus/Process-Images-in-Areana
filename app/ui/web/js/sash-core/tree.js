...
function sashDefaultTree() {
  return sashSplit('col', [
    ...
    sashSplit('row', [
      ...
      sashSplit('col', [sashLeaf('browser'), sashLeaf('arena_presets'), sashLeaf('progress'), sashLeaf('watcher'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('uivision')], [20, 15, 12, 15, 13, 13, 12]),
    ], [45, 35, 20]),
    sashLeaf('log'),
  ], [38, 40, 22]);
}
...
function sashLayoutA() {
  return sashSplit('col', [
    ...
    sashLeaf('action_blocks'), sashLeaf('block_config'), sashLeaf('arena_presets'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('uivision'),
  ], [7, 5, 9, 8, 6, 6, 5, 7, 6, 6, 6, 5, 5, 5, 5, 4, 3, 3]);
}
...
function sashLayoutB() {
  return sashSplit('row', [
    ...
    sashSplit('col', [sashLeaf('browser'), sashLeaf('settings'), sashLeaf('captcha'), sashLeaf('recordings'), sashLeaf('arena_presets'), sashLeaf('run'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('uivision')], [11, 11, 11, 11, 11, 11, 11, 11, 12]),
  ], [35, 35, 30]);
}
...
function sashLayoutC() {
  return sashSplit('col', [
    ...
    sashSplit('row', [
      sashLeaf('queue'),
      sashSplit('col', [sashLeaf('folder'), sashLeaf('run'), sashLeaf('settings'), sashLeaf('captcha'), sashLeaf('recordings'), sashLeaf('progress'), sashLeaf('watcher'), sashLeaf('arena_presets'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('uivision')], [10, 10, 10, 10, 10, 10, 10, 10, 10, 5, 5]),
    ], [60, 40]),
    sashLeaf('log'),
  ], [35, 48, 17]);
}
