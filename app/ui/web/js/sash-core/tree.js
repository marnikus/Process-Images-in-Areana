...
function sashDefaultTree() {
  return sashSplit('col', [
    ...
    sashSplit('row', [
      ...
      sashSplit('col', [sashLeaf('browser'), sashLeaf('firefox_auto'), sashLeaf('arena_presets'), sashLeaf('progress'), sashLeaf('watcher'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('workspace')], [16, 13, 11, 12, 13, 12, 12, 11]),
    ], [45, 35, 20]),
    sashLeaf('log'),
  ], [38, 40, 22]);
}
...
function sashLayoutA() {
  return sashSplit('col', [
    ...
    sashLeaf('action_blocks'), sashLeaf('block_config'), sashLeaf('arena_presets'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('firefox_auto'), sashLeaf('workspace'),
  ], [6, 4, 8, 8, 6, 6, 5, 6, 6, 6, 6, 5, 5, 6, 5, 4, 4, 4, 6]);
}
...
function sashLayoutB() {
  return sashSplit('row', [
    ...
    sashSplit('col', [sashLeaf('browser'), sashLeaf('firefox_auto'), sashLeaf('settings'), sashLeaf('captcha'), sashLeaf('recordings'), sashLeaf('arena_presets'), sashLeaf('run'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('workspace')], [11, 10, 10, 10, 10, 10, 10, 10, 10, 9]),
  ], [35, 35, 30]);
}
...
function sashLayoutC() {
  return sashSplit('col', [
    ...
    sashSplit('row', [
      sashLeaf('queue'),
      sashSplit('col', [sashLeaf('folder'), sashLeaf('run'), sashLeaf('settings'), sashLeaf('captcha'), sashLeaf('recordings'), sashLeaf('progress'), sashLeaf('watcher'), sashLeaf('arena_presets'), sashLeaf('live_debug'), sashLeaf('job_history'), sashLeaf('firefox_auto'), sashLeaf('workspace')], [9, 8, 9, 9, 9, 9, 9, 9, 8, 7, 4, 10]),
    ], [60, 40]),
    sashLeaf('log'),
  ], [35, 48, 17]);
}
