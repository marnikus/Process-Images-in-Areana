...
function sashDefaultTree() {
  return sashSplit('col', [
    ...
    sashSplit('row', [
      ...
      sashSplit('col', [sashLeaf('browser'), sashLeaf('arena_presets'), sashLeaf('progress'), sashLeaf('watcher'), sashLeaf('live_debug')], [24, 20, 16, 20, 20]),
    ], [45, 35, 20]),
    sashLeaf('log'),
  ], [38, 40, 22]);
}
...
function sashLayoutA() {
  ...
  ], [7, 5, 9, 8, 6, 6, 6, 6, 6, 6, 7, 6, 6, 6, 5, 5]);
}
...
function sashLayoutB() {
  return sashSplit('row', [
    ...
    sashSplit('col', [sashLeaf('browser'), sashLeaf('settings'), sashLeaf('captcha'), sashLeaf('recordings'), sashLeaf('arena_presets'), sashLeaf('run'), sashLeaf('live_debug')], [28, 12, 12, 12, 12, 12, 12]),
  ], [35, 35, 30]);
}
...
function sashLayoutC() {
  return sashSplit('col', [
    ...
    sashSplit('row', [
      sashLeaf('queue'),
      sashSplit('col', [sashLeaf('folder'), sashLeaf('run'), sashLeaf('settings'), sashLeaf('captcha'), sashLeaf('recordings'), sashLeaf('progress'), sashLeaf('watcher'), sashLeaf('arena_presets'), sashLeaf('live_debug')], [12, 11, 12, 12, 11, 11, 11, 10, 10]),
    ], [60, 40]),
    sashLeaf('log'),
  ], [35, 48, 17]);
}
