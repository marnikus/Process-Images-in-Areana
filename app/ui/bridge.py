...
class Bridge(QObject):
    ...
    # ---- Captcha session recordings ----
    # The recordings window has its own QWebChannel adapter
    # (app/ui/services/captcha_recordings_bridge.py, object "captchaRecordings"),
    # so this Bridge stays inside the RULE 16 size budget: no recording slots here.
