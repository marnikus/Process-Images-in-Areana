...
PROBE_FILES = [
    # C3 split: payloads live in the cdp_arena package (facade re-exports).
    "app/browser/cdp_arena/js_snippets.py",
    "app/browser/cdp_arena/submit.py",
    "app/browser/cdp_arena/highlight.py",
